...
export const countBetweenDates = (secondDate: any, firstDate: any) => {
...
export const DiasTrabajadosDeQuincena = (
  ultimoDia: number,
  segundaFechaDiasTrabajados: number,
  primerDia: any,
  diferenciaDiasUltimoPrimerDia: any,
  difAños: any,
  difMeses: any
) => {
...
export const diasRestantesQuincena = (
  ultimoDia: number,
  param: any,
  param2: any
) => {
...
export const diasTrabajadosSemestre = (
  ultimoDia: number,
...
export const DiasTrabajadosUltimoAño = () => {
  let diasTrabajadosUltimoAño: any;
